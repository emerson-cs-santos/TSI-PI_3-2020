                            ...
                            <div class="col-12">
                                ...
                                <form action="{{route('movimentos.update', $movimento->id)}}" class='p-3 bg-white' method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class='form-control' name="fk_produto" id="fk_produto" onkeydown="return event.keyCode !== 69" required placeholder="Digite o id do produto" value="{{$movimento->product_id}}">
                                    </div>
