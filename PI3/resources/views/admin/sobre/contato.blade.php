                            ...
                            <div class="col-12">
                                ...
                                <form action="{{route('sobre-contato-atualizar')}}" class='p-3 bg-white' method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class='form-control' name="Titulo" autofocus required placeholder="Digite um título" value="{{$contato->titulo}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="Texto">Texto*</label>
                                        <textarea name="Texto" class='form-control' rows=15 required placeholder="Digite as informações para contato">{{$contato->texto}}</textarea>
                                    </div>
